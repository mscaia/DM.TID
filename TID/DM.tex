...
\\
De plus, lors de la construction de l'abre, le choix de la deuxième variable de segmentations n'a pas d'inmportance, étant donné qu'il nous reste deux variables de segmentation. 
\newpage
\begin{figure}
  \begin{center}
    \begin{tikzpicture}[
...
\begin{table}[H]
  ...
  On a :
\[
H(Z_1)= -(\frac{29}{72}ln(\frac{29}{72})+\frac{43}{72}ln(\frac{43}{72}))
\]
\[
H(Y)=-(\frac{22}{72}ln(\frac{22}{72})+\frac{50}{72}ln(\frac{50}{72}))
\]
\[
H(Z_1,Y)=-(\frac{2}{72}log(\frac{2}{72})+\frac{27}{72}log(\frac{27}{72})+\frac{20}{72}log(\frac{20}{72})+\frac{23}{72}log(\frac{23}{72}))
\]
